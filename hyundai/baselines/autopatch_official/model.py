...
try:
    # Package import (e.g., from hyundai.baselines.autopatch_official import Model)
    from .sampler import ApproximateGreedyCoresetSampler
    from .torchmetrics_v1_9_3 import _auroc_compute, precision_recall_curve
except ImportError:
    # Script-local import (e.g., python hyundai/baselines/autopatch_official/search.py)
    from sampler import ApproximateGreedyCoresetSampler
    from torchmetrics_v1_9_3 import _auroc_compute, precision_recall_curve
